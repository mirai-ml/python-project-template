...
├── MIRAI_PACKAGE             # The main python package for the project
...
Just click on [Use this template](https://github.com/mirai-ml/python-project-template/generate) and you are good to go.
...
e.g: `cat MIRAI_PACKAGE/VERSION` will get the project version without harming
